...
const Social = ({handleSignInWithGoogle}) => {
    return (
        <div>
            ...
            <div >
                <button className='d-flex align-items-center justify-content-center mx-auto social-login-button'>
            <span className='google-size me-2'>sign in with</span>
                <FontAwesomeIcon onClick={handleSignInWithGoogle}  className='fs-5 logo-backgound' icon={faGoogle}></FontAwesomeIcon>
                </button>
            </div>
        </div>
    );
